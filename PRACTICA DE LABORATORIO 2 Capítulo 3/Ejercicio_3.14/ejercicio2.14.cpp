...
void displayAccount(Account accountToDisplay) {
            cout << endl; 
            cout << "-Account: " << accountToDisplay.getName() <<" " <<accountToDisplay.getLastname() <<endl<< "Account number: " << accountToDisplay.getaccountnumber()<<endl << "Your balance is $" << accountToDisplay.getBalance() << endl;
            cout << endl;
        }


int main(){
    Account account1{"Stefano", "Ballesteros", 123456789,50};
    Account account2{"Pachito", "Blue",123412313,-7};
